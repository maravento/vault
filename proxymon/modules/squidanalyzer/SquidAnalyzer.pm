...
sub _init
{
	...
	if (!$conf_file) {
		if (-f '/var/www/proxymon/squidanalyzer/squidanalyzer.conf') {
			$conf_file = '/var/www/proxymon/squidanalyzer/squidanalyzer.conf';
		} elsif (-f '/var/www/proxymon/squidanalyzer/etc/squidanalyzer.conf') {
			$conf_file = '/var/www/proxymon/squidanalyzer/etc/squidanalyzer.conf';
...
<body onload="if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',function(){if(typeof sorttable!=='undefined'&&sorttable.innerSortFunction){$sorttable}});}else{if(typeof sorttable!=='undefined'&&sorttable.innerSortFunction){$sorttable}}">
<div id="conteneur">
<a name="atop"></a>
	<div id="header">
		<div id="alignLeft">
