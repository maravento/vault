...
wget https://kryogenix.org/code/browser/sorttable/sorttable.js -O orig/sorttable.js || { echo "ERROR: failed to download sorttable.js"; exit 1; }
...
wget https://raw.githubusercontent.com/HumbleSoftware/Flotr2/master/flotr2.nolibs.js -O orig/flotr2.nolibs.js || { echo "ERROR: failed to download flotr2.nolibs.js"; exit 1; }

yui-compressor orig/flotr2.nolibs.js -o orig/flotr2.min.js

# Update the bean.js script
wget https://github.com/fat/bean/archive/v1.0.14.tar.gz || { echo "ERROR: failed to download bean"; exit 1; }
...
wget https://underscorejs.org/underscore.js -O orig/underscore.js || { echo "ERROR: failed to download underscore.js"; exit 1; }
