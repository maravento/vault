...
#   - Works with both systemd-networkd and NetworkManager backends
#   - Includes responsive layout and action buttons for quick management
#
# Usage:
#   sudo ./networkd.sh [OPTIONS]
#
# Options:
...
#
# Examples:
#   sudo ./networkd.sh              # Interactive menu
#   sudo ./networkd.sh install      # Direct installation
#   sudo ./networkd.sh uninstall    # Direct uninstallation
...
EOF
    ...
    # 9. networkd-lib.pl
    # ============================================================
    cat > "$MODDIR/networkd-lib.pl" <<'EOF'
#!/usr/bin/perl
...
EOF
    ...
    chmod 755 "$MODDIR/networkd-lib.pl"
