...
install_joomla() {
    ...
    # PHP
    apt install php php-mysql php-xml php-mbstring php-curl php-zip php-gd libapache2-mod-php php-cli php-intl php-bcmath unzip -y
...
<VirtualHost *:443>
    ...
    SSLEngine on
    SSLCertificateFile      $(pwd)/localhost.pem
    SSLCertificateKeyFile   $(pwd)/localhost-key.pem
