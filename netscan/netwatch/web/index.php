...
<!-- Both iframes load from the start and stay in the DOM permanently --
     tab switching only toggles display:none, it never recreates or
     reloads either iframe. -->
<div class="frame-container">
    <iframe id="frame-lan" src="/lan/" style="<?= $tab === 'lan' ? '' : 'display:none' ?>"></iframe>
    <iframe id="frame-ports" src="/ports/" style="<?= $tab === 'ports' ? '' : 'display:none' ?>"></iframe>
</div>
...
<script>
    ...
    function visibleFrame() {
        return [...document.querySelectorAll('.frame-container iframe')]
    ...
    // Tab switching: both iframes load immediately (see the <iframe> tags
    // above) and stay alive in the DOM permanently. Switching tabs only
    // toggles display:none, it never recreates or reloads either iframe.
    // Each child page exposes onShow()/onHide(). onShow repaints instantly
    // from the data it already holds (so the tab you switch back to shows
    // values immediately, never a blank while the network refresh is in
